            ...
            <div className="row">
                ...
                <div className="col-12 col-lg-6 col-xl-7 px-lg-5 py-lg-4">
                    ...
                    <p className="fw-lighter">
                        Hi, I'm a full stack developer based out of Bombay(India) with LAMP and MEAN stack development experience for over 8 years. I have maintained, developed and launched multiple projects from scratch, including providing UI/UX inputs, ideation of architecture and building complete end-to-end workflows in grunt and automated integration tools such as Bamboo (by Atlassian).
                        <br/><br/>
